...
Hashtable implementation was taken from LambdaC 
...
/**
 * Put data pointer to hash table with a string key
 */
...
/**
 * Put put data pointer to hash table with a binary key
 */
